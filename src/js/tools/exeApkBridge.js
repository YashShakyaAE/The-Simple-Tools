        ...
        <div style="margin-top:1.75rem; background:rgba(20,20,32,0.7); border:1px solid var(--border-glass); border-radius:var(--radius-lg); padding:1.5rem;">
          ...
          <div class="tool-controls-row">
            <div class="control-item">
              ...
              <input type="text" class="control-input" id="bridge-app-name" value="TheSimpleTools Mobile App" />
            </div>
            <div class="control-item">
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    const bridgeConfig = {
      ...
      generator: "TheSimpleTools Executable to Android Bridge Suite",
...
<body>
  <div class="card">
    ...
    <p style="color:#94a3b8; font-size:0.9rem;">Built with TheSimpleTools</p>
  </div>
</body>
</html>`;
...
Generated by **TheSimpleTools** (The Ultimate All-in-One Online Utility Toolbox).
